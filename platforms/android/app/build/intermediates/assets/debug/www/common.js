...
/***/ "./src/app/allselections/allselections.module.ts":
/*!*******************************************************!*\
  !*** ./src/app/allselections/allselections.module.ts ***!
  \*******************************************************/
/*! exports provided: AllselectionsPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AllselectionsPageModule", function() { return AllselectionsPageModule; });
...
/* harmony import */ var _allselections_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./allselections.page */ "./src/app/allselections/allselections.page.ts");
...
var routes = [
    {
        path: '',
        component: _allselections_page__WEBPACK_IMPORTED_MODULE_6__["AllselectionsPage"]
    }
];
var AllselectionsPageModule = /** @class */ (function () {
    function AllselectionsPageModule() {
    }
    AllselectionsPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_allselections_page__WEBPACK_IMPORTED_MODULE_6__["AllselectionsPage"]]
        })
    ], AllselectionsPageModule);
    return AllselectionsPageModule;
}());
...
/***/ "./src/app/allselections/allselections.page.html":
/*!*******************************************************!*\
  !*** ./src/app/allselections/allselections.page.html ***!
  \*******************************************************/
...
/***/ "./src/app/allselections/allselections.page.ts":
/*!*****************************************************!*\
  !*** ./src/app/allselections/allselections.page.ts ***!
  \*****************************************************/
/*! exports provided: AllselectionsPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AllselectionsPage", function() { return AllselectionsPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! firebase */ "./node_modules/firebase/dist/index.cjs.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(firebase__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _services_playlist_playlist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/playlist/playlist */ "./src/app/services/playlist/playlist.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var AllselectionsPage = /** @class */ (function () {
    function AllselectionsPage(playlistService, router, loadingCtrl) {
        this.playlistService = playlistService;
        this.router = router;
        this.loadingCtrl = loadingCtrl;
        this.selections = new Array();
    }
    AllselectionsPage.prototype.goToPlaylist = function (playlist) {
        this.router.navigateByUrl("/tabs/(home:selection/NbtwzggJpfYmu1rN4lqdCNBBSVu1/" + playlist.key + ")");
    };
    AllselectionsPage.prototype.ngOnInit = function () {
        this.loadAllSelections();
    };
    AllselectionsPage.prototype.loadAllSelections = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        loading = _a.sent();
                        loading.present();
                        storage = firebase__WEBPACK_IMPORTED_MODULE_1__["storage"]();
                        this.playlistService.getSelections(1000).then(function (data) {
    ...
    AllselectionsPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-allselections',
            template: __webpack_require__(/*! ./allselections.page.html */ "./src/app/allselections/allselections.page.html"),
            styles: [__webpack_require__(/*! ./allselections.page.scss */ "./src/app/allselections/allselections.page.scss")],
        }),
        __metadata("design:paramtypes", [_services_playlist_playlist__WEBPACK_IMPORTED_MODULE_2__["PlaylistProvider"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _playlist_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./playlist.page */ "./src/app/playlist/playlist.page.ts");
...
var routes = [
    {
        path: '',
        component: _playlist_page__WEBPACK_IMPORTED_MODULE_5__["PlaylistPage"]
    }
];
var PlaylistPageModule = /** @class */ (function () {
    ...
    PlaylistPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_playlist_page__WEBPACK_IMPORTED_MODULE_5__["PlaylistPage"]]
        })
    ], PlaylistPageModule);
...
/***/ "./src/app/playlist/playlist.page.html":
/*!*********************************************!*\
  !*** ./src/app/playlist/playlist.page.html ***!
  \*********************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n    <ion-toolbar color=\"fg-header\">\n        \n          <ion-buttons slot=\"start\">\n              <ion-back-button id=\"backButton\" defaultHref=\"/\"></ion-back-button>\n          </ion-buttons>\n          <ion-buttons slot='end'>\n            <ion-button icon-only (click)=\"goToAbout()\">\n              <ion-icon name=\"information-circle\"></ion-icon>\n            </ion-button>\n          </ion-buttons>\n          <ion-title class='center' *ngIf=\"playlist\">{{playlist.title}}</ion-title>\n      </ion-toolbar>\n</ion-header>\n\n<ion-content padding class='fg-content'>\n    <ion-show-when size=\"md, lg, xl\"><h1 *ngIf=\"playlist\">{{playlist.title}}</h1></ion-show-when>\n    <ion-grid>\n            <app-item-video [videos]=\"videos\" [role]=\"role\" [display]=\"'playlist'\" [playlist]=\"playlist\"></app-item-video>\n    </ion-grid>\n</ion-content>"
...
/* harmony import */ var _services_playlist_playlist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/playlist/playlist */ "./src/app/services/playlist/playlist.ts");
/* harmony import */ var _services_video_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/video/video */ "./src/app/services/video/video.ts");
...
var PlaylistPage = /** @class */ (function () {
    function PlaylistPage(route, videoService, profileService, playlistService, router, platform, authService) {
        var _this = this;
        this.route = route;
        ...
        this.playlistService.getPlaylistById(this.userKey, this.key).then(function (result) {
            _this.playlist = result;
            return result;
        }).then(function (playlist) {
            _this.playlistService.getVideos(_this.userKey, playlist).then(function (data) {
                _this.videos = data;
            });
        });
    }
    PlaylistPage.prototype.goToAbout = function () {
        this.router.navigateByUrl("about");
    };
    PlaylistPage.prototype.goToHome = function () {
    ...
    PlaylistPage.prototype.ngOnDestroy = function () {
        //this.inscBackButton.unsubscribe();
    };
    PlaylistPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-playlist',
            template: __webpack_require__(/*! ./playlist.page.html */ "./src/app/playlist/playlist.page.html"),
            styles: [__webpack_require__(/*! ./playlist.page.scss */ "./src/app/playlist/playlist.page.scss")],
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            _services_video_video__WEBPACK_IMPORTED_MODULE_3__["VideoProvider"],
            _services_profile_profile__WEBPACK_IMPORTED_MODULE_4__["ProfileProvider"],
            _services_playlist_playlist__WEBPACK_IMPORTED_MODULE_2__["PlaylistProvider"],
...
var EmailValidator = /** @class */ (function () {
    ...
    EmailValidator.isValid = function (control) { var re = /^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$/.test(control.value); if (re) {
        return null;
