...
/* harmony import */ var _reset_password_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./reset-password.page */ "./src/app/reset-password/reset-password.page.ts");
...
var ResetPasswordPage = /** @class */ (function () {
    function ResetPasswordPage(router, navCtrl, loadingCtrl, alertCtrl, authProvider, formBuilder) {
        this.router = router;
    ...
    ResetPasswordPage.prototype.resetPassword = function () {
        ...
        if (!this.resetPasswordForm.valid) {
            ...
            this.authProvider.resetPassword(email).then(function (user) {
                var message = "Check your email for a password reset link";
                _this.showAlert(message);
            }, function (error) {
                var message = "Error :( I'm sorry ...";
                _this.showAlert(message);
            });
        }
    };
    ResetPasswordPage.prototype.showAlert = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.alertCtrl.create({ message: message, buttons: [{ text: "Ok", role: "cancel" }] })];
                    case 1:
                        alert = _a.sent();
    ...
    ResetPasswordPage = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_1__["AlertController"], _services_auth_auth__WEBPACK_IMPORTED_MODULE_4__["AuthProvider"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], ResetPasswordPage);
